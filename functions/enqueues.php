...
function bstv2_enqueues() {
	...
	wp_enqueue_style('bootstrap-css');
  	...
  	wp_register_style('fontawesome-css', get_template_directory_uri() . '/css/font-awesome.min.css', false, null);
	wp_enqueue_style('fontawesome-css');
	
  	wp_register_style('bstv2-css', get_template_directory_uri() . '/css/bstv2.css', false, null);
	wp_enqueue_style('bstv2-css');
	...
	wp_register_script('bstv2-js', get_template_directory_uri() . '/js/bstv2.js', false, null, true);
	wp_enqueue_script('bstv2-js');

	if (is_singular() && comments_open() && get_option('thread_comments')) {
		wp_enqueue_script('comment-reply');
	}
}
add_action('wp_enqueue_scripts', 'bstv2_enqueues', 100);
