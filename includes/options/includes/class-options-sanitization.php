...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'bstv2' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'bstv2' ),
		'repeat-y'  => __( 'Repeat Vertically', 'bstv2' ),
		'repeat'    => __( 'Repeat All', 'bstv2' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'bstv2' ),
		'top center'    => __( 'Top Center', 'bstv2' ),
		'top right'     => __( 'Top Right', 'bstv2' ),
		'center left'   => __( 'Middle Left', 'bstv2' ),
		'center center' => __( 'Middle Center', 'bstv2' ),
		'center right'  => __( 'Middle Right', 'bstv2' ),
		'bottom left'   => __( 'Bottom Left', 'bstv2' ),
		'bottom center' => __( 'Bottom Center', 'bstv2' ),
		'bottom right'  => __( 'Bottom Right', 'bstv2')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'bstv2' ),
		'fixed'  => __( 'Fixed in Place', 'bstv2')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'bstv2' ),
		'italic'      => __( 'Italic', 'bstv2' ),
		'bold'        => __( 'Bold', 'bstv2' ),
		'bold italic' => __( 'Bold Italic', 'bstv2' )
		);
